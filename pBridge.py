...
def pBridgeFunc(folderIn, folderOut, fileXLSX, fileIn):
    ...
    kindOfHMConfigID = ET.SubElement(data, "KIND_OF_HM_CONFIG_ID").text = "Linewidth"

    procedureType = ET.SubElement(data, "PROCEDURE_TYPE").text = 'Linewidth-pPlus'
    ...
    sheet = wb_obj.active
    t = (sheet["B18"].value)*128.5/(sheet["B19"].value)
    t = round(t, 3)
    TUm = ET.SubElement(data3, "T_UM").text = str(t)
