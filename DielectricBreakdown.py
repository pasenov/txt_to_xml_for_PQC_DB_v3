...
def DielectricBreakdownFunc(folderIn, folderOut, fileXLSX, fileIn):
    ...
    procedureType = ET.SubElement(data, "PROCEDURE_TYPE").text = 'DielBreakdown_alt'
    ...
    sheet = wb_obj.active
    Vbd_val = sheet["B13"].value
    Vbd_val = round(Vbd_val, 3)
    VbdV = ET.SubElement(data3, "VBD_V").text = str(Vbd_val)
