...
def FETFunc(folderIn, folderOut, fileXLSX, fileIn):
    ...
    if (n8 == 'FET'):
        ...
        nameTest2 = 'Tracker Halfmoon TC Parameters'
    ...
    procedureType = ET.SubElement(data, "PROCEDURE_TYPE").text = 'FET1'
    ...
    Vth = sheet["B6"].value
    Vth = round(Vth, 3)
    VthV = ET.SubElement(data3, "VTH_V").text = str(Vth)
